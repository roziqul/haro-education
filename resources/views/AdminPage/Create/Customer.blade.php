                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama"
                                                    placeholder="Masukkan nama Customer" name="nama">
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email</label>
                                                <input type="text" class="form-control" id="email"
                                                    placeholder="Masukkan email Customer" name="email">
                                            </div>
                                            <div class="form-group">
                                                <label for="nowa">No. Whatsapp</label>
                                                <input type="text" class="form-control" id="nowa"
                                                    placeholder="Masukkan nomor Whatsapp" name="nowa">
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
