                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="{{ route('BeritaSave') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="gbr">Gambar</label>
                                            <input type="file" class="form-control" id="gbr"
                                                placeholder="Upload Gambar" name="gbr">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="deskripsi"
                                                placeholder="Masukkan deskripsi" name="deskripsi" rows="7"></textarea>
                                        </div>
