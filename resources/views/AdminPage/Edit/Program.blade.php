                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="{{ route('ProgramUpdate') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                            @foreach ($editProgram as $prg)
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input type="hidden" class="form-control" id="id" name="id" value="{{ $prg->id }}">
                                                <input type="text" class="form-control" id="nama" placeholder="Masukkan nama paket" name="nama" value="{{ $prg->nama }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="harga">Harga</label>
                                                <input type="text" class="form-control" id="harga" placeholder="Masukkan harga paket" name="harga" value="{{ $prg->harga }}">
                                            </div>
                                            @endforeach
                                        </div>
                                        <!-- /.card-body -->
