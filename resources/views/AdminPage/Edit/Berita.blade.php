                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('BeritaUpdate') }}" method="post"
                                        ...
                                        @csrf
                                        <div class="card-body">
                                            @foreach ($editBerita as $eb)
                                            <div class="form-group">
                                                <label for="gbr">Foto</label>
                                                <input type="hidden" class="form-control" id="id" name="id" value="{{ $eb->id }}">
                                                <input type="file" class="form-control" id="gbr" name="gbr" value="{{ $eb->gbr }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="judul">Judul</label>
                                                <input type="text" class="form-control" id="judul" placeholder="Masukkan judul" name="judul" value="{{ $eb->judul }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="asal">Deskripsi</label>
                                                <textarea class="form-control" id="deskripsi" placeholder="Masukkan deskripsi" name="deskripsi" rows="7">{{ $eb->deskripsi }}"</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                        <!-- /.card-body -->
