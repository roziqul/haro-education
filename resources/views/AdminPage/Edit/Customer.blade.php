                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('CustomerUpdate') }}" method="post"
                                        ...
                                        @csrf
                                        <div class="card-body">
                                            @foreach ($editCustomer as $eC)
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input type="hidden" class="form-control" id="id" name="id" value="{{ $eC->id }}">
                                                <input type="text" class="form-control" id="nama" placeholder="Masukkan nama Customer" name="nama" value="{{ $eC->nama }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email</label>
                                                <input type="text" class="form-control" id="email" placeholder="Masukkan email Customer" name="email" value="{{ $eC->email }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="nowa">No. Whatsapp</label>
                                                <input type="text" class="form-control" id="nowa" placeholder="Masukkan nomor Whatsapp" name="nowa" value="{{ $eC->nowa }}">
                                            </div>
                                            @endforeach
                                        </div>
                                        <!-- /.card-body -->
