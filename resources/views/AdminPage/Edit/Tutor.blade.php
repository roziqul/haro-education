                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="{{ route('TutorUpdate') }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body">
                                            @foreach ($editTutor as $et)
                                            <div class="form-group">
                                                <label for="name">Mapel</label>
                                                <input type="hidden" class="form-control" id="id" name="id" value="{{ $et->id }}">
                                                <input type="text" class="form-control" id="name" placeholder="Masukkan mapel" name="name" value="{{ $et->name }}">
                                            </div>
                                            @endforeach
                                        </div>
                                        <!-- /.card-body -->
